    ...
    QWidget(parent)
{
    ...
    audioTypes = new QStandardItem(QIcon(":/icons/audio-icon.png"),"Audio");
    videoTypes = new QStandardItem(QIcon(":/icons/video-icon.png"),"Video");
    ...
    QIcon cancelIcon(":/icons/Cancel-icon.png");
    QString cancelText("revert changes");
    QIcon acceptIcon(":/icons/confirm-icon.png");
